...
*(Add a screenshot of the Main.xaml workflow open in UiPath Studio to `screenshots/workflow.png`.)*

## Output Screenshot

*(Add a screenshot of `output/Invoice_Report.xlsx` open in Excel to `screenshots/output.png`.)*
